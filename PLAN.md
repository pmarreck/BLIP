...
- [x] Curate `BLIP_CONTAINER_SPEC.md` → `BLIP_WIRE_SPEC.md`: LP envelope + attribute framework, scalar sentinels, ARRAY/DICT/MAP/DATA/UTF8/RAW, SEGMENT, **COMP/CSUM/ENC as *optional* attributes**, streaming/scratch, determinism, + printable-binary & JSON human-readable representations. Code-comment + doc refs repointed (blip.zig, segmentation.zig, transport_embedding.md). (2026-07-02)
